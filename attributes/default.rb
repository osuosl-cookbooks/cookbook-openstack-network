...
default['openstack']['network']['service_provider'] = %w(router)
...
# ============================= FWaaS Configuration ==================
# To enable 'firewall' as service_plugin, you need to add it to
# neutron.conf
# ['default']['service_plugins']
...
default['openstack']['network']['platform'].tap do |platform|
  ...
  when 'fedora', 'rhel' # :pragma-foodcritic: ~FC024 - won't fix this
    ...
    platform['neutron_fwaas_packages'] = %w(openstack-neutron-fwaas)
  ...
  when 'debian'
    ...
    platform['neutron_fwaas_packages'] = %w(python3-neutron-fwaas)
    platform['neutron_lbaas_packages'] =
      %w(
        haproxy
